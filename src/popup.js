...
const firebaseConfig = {
  ...
  messagingSenderId: "014275208354",
  appId: "1:1014275208354:web:8f56c96db8aa89ba4e53fb",
};
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Make sure these event listeners are properly set up in popup.js
  document.addEventListener("DOMContentLoaded", function () {
    // Auth elements
    const emailInput = document.getElementById("email");
    const passwordInput = document.getElementById("password");
    ...
    // Make sure these other event listeners are also properly set up
